          ...
          {education.map((item, index) => {
            ...
            return (
              <AnimateIn key={index} variant="fadeLeft" delay={delay}>
                <Link
                  href="https://mscollege.org.in/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="group p-5 rounded-xl bg-white shadow-[0_0_20px_rgba(55,65,81,0.12)] hover:shadow-[0_0_30px_rgba(55,65,81,0.18)] hover:translate-x-1 transition-all duration-300 ease-out relative">
                    {/* Timeline dot */}

                    <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-2 gap-1">
                      <h3 className="text-lg w-fit font-semibold text-zinc-900">
                        {item.degree}
                      </h3>
