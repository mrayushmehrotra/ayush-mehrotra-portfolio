    ...
    >
      ...
      <VerticalTimeline>
        ...
        >
          ...
          <p>Developed and optimized web applications, ensured responsive designs, and collaborated in code reviews.</p>
        </VerticalTimelineElement>
        ...
        >
          ...
          <p>Built a React.js dashboard to manage records for over 150+ employees efficiently.</p>
        </VerticalTimelineElement>
        ...
        >
          ...
          <p>Enhanced API performance by 25% using Redis caching and optimized React hooks.</p>
        </VerticalTimelineElement>
        ...
        >
          ...
          <p>Implemented a Facebook chat plugin for directing customer care support to users.</p>
        </VerticalTimelineElement>
        ...
        >
          ...
          <p>Developed a WhatsApp event notifier system to enhance user interactions and notifications.</p>
        </VerticalTimelineElement>
