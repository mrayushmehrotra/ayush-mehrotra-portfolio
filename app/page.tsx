          ...
          {FAQ_ITEMS.map((item, i) => {
            ...
            return (
              <li
                ...
                ref={(el) => {
                  /* nothing — we use the onMouseMove on the div below */
                }}
                style={
                  {
                    position: "relative",
  ...
  return (
    <div className="page-reveal" itemScope itemType="https://schema.org/Person">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center fade-up mt-10">
          <span 
            className="text-[10px] sm:text-[11px] md:text-xs tracking-[0.3em] font-bold uppercase mb-4 sm:mb-6"
            style={{ color: "var(--cream)", fontFamily: "var(--font-inter)" }}
          >
            Software Engineer
          </span>
          <h1 
            className="text-6xl sm:text-8xl md:text-[7rem] lg:text-[8rem] font-bold tracking-tighter mb-4 sm:mb-6"
            style={{ color: "var(--cream)", fontFamily: "var(--font-inter)", lineHeight: 1 }}
          >
            Ayush Mehrotra
          </h1>
          <div 
            className="flex flex-col items-center gap-1 sm:gap-1.5 text-sm sm:text-base md:text-lg font-medium"
            style={{ color: "var(--cream)", fontFamily: "var(--font-inter)" }}
          >
            <p>Full-Stack Frontend Engineer @ Wealthfino</p>
            <p className="text-xs sm:text-sm font-normal" style={{ color: "rgba(237,229,212,0.75)" }}>
